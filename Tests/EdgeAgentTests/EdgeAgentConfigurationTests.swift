...
@Suite("EdgeAgentConfiguration")
struct EdgeAgentConfigurationTests {
    ...
    func testConfigurationFromEnvironmentConnMan() {
        ...
        let originalValue = ProcessInfo.processInfo.environment["EDGE_NETWORK_MANAGER"]

        // Set environment variable
        setenv("EDGE_NETWORK_MANAGER", "connman", 1)
        ...
        if let original = originalValue {
            setenv("EDGE_NETWORK_MANAGER", original, 1)
        } else {
            unsetenv("EDGE_NETWORK_MANAGER")
        }
    }
    ...
    func testConfigurationFromEnvironmentNetworkManager() {
        ...
        // Set environment variable
        setenv("EDGE_NETWORK_MANAGER", "networkmanager", 1)
    ...
    func testConfigurationFromEnvironmentForceConnMan() {
        ...
        // Set environment variable
        setenv("EDGE_NETWORK_MANAGER", "force-connman", 1)
    ...
    func testConfigurationFromEnvironmentForceNetworkManager() {
        ...
        // Set environment variable
        setenv("EDGE_NETWORK_MANAGER", "force-networkmanager", 1)
    ...
    func testConfigurationFromEnvironmentInvalid() {
        ...
        setenv("EDGE_NETWORK_MANAGER", "invalid-manager", 1)
    ...
    func testConfigurationFromEnvironmentNetworkManagerWithHyphen() {
        ...
        // Set environment variable
        setenv("EDGE_NETWORK_MANAGER", "network-manager", 1)
