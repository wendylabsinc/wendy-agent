...
struct HardwareDiscoveryIntegrationTest {
    ...
    func testHardwareDiscoveryProtobufMessages() throws {
        ...
        var request = EdgeAgentGRPC.Edge_Agent_Services_V1_ListHardwareCapabilitiesRequest()
        ...
        var response = EdgeAgentGRPC.Edge_Agent_Services_V1_ListHardwareCapabilitiesResponse()
        #expect(response.capabilities.isEmpty)

        // Test hardware capability message creation
        var capability = EdgeAgentGRPC.Edge_Agent_Services_V1_ListHardwareCapabilitiesResponse
            .HardwareCapability()
    ...
    func testProtobufStructure() throws {
        ...
        let request = EdgeAgentGRPC.Edge_Agent_Services_V1_ListHardwareCapabilitiesRequest()
        let response = EdgeAgentGRPC.Edge_Agent_Services_V1_ListHardwareCapabilitiesResponse()
        ...
        #expect(
            type(of: response.capabilities)
                == Array<
                    EdgeAgentGRPC.Edge_Agent_Services_V1_ListHardwareCapabilitiesResponse
                        .HardwareCapability
                >.self
        )

        // Capability should have expected fields
        let capability = EdgeAgentGRPC.Edge_Agent_Services_V1_ListHardwareCapabilitiesResponse
            .HardwareCapability()
