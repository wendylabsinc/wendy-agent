...
All WendyOS apps are container-based and require a `Dockerfile` in your project directory. When you run `wendy run`, the CLI automatically prepares the local build environment, builds your container image for the ARM64 architecture, and ships it directly to your WendyOS device.
