...
**Note:** Entitlements apply to `wendyos` platform apps only. For `darwin` (native macOS) apps, entitlements are not used; the app runs with standard macOS permissions.
