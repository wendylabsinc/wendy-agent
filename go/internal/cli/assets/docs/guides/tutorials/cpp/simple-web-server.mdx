...
<Steps>
  <Step>
    ...
    <CliShot flow="init" step="wizard" alt="wendy init scaffolding the C++ simple-server project" />
  ...
  <Step>
    ...
    <CliShot flow="run" step="deploy" alt="wendy run deploying the C++ Drogon simple-server" />
