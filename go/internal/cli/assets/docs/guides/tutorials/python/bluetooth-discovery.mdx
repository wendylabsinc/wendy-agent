...
<Steps>
  <Step>
    ...
    <CliShot flow="init" step="wizard" alt="wendy init scaffolding the bluetooth-discovery Python project" />
...
<CliShot flow="run" step="deploy" alt="wendy run building and deploying the Bluetooth discovery app to a WendyOS device" />
