...
<Steps>
  <Step>
    ...
    <CliShot flow="init" step="wizard" alt="wendy init scaffolding the webcam streaming project from the camera-feed template" />
  ...
  <Step>
    ...
    <CliShot flow="run" step="deploy" alt="wendy run building and deploying the webcam streaming app to a WendyOS device" />
