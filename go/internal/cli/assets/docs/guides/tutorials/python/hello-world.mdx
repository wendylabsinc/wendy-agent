...
<Steps>
  <Step>
    ...
    <CliShot flow="init" step="wizard" alt="wendy init scaffolding the hello-world Python project from the simple-api template" />
  ...
  <Step>
    ...
    <CliShot flow="run" step="deploy" alt="wendy run building and deploying the hello-world app to a WendyOS device" />
