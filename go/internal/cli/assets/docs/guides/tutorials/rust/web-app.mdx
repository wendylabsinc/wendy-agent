...
<Steps>
  <Step>
    ...
    <CliShot flow="init" step="wizard" alt="wendy init scaffolding the full-stack Rust web-app project" />
  ...
  <Step>
    ...
    <CliShot flow="run" step="deploy" alt="wendy run building and deploying the full-stack web app" />
