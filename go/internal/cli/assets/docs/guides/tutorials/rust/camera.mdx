...
<Steps>
  <Step>
    ...
    <CliShot flow="init" step="wizard" alt="wendy init scaffolding the Rust camera-feed project" />
  ...
  <Step>
    ...
    <CliShot flow="run" step="deploy" alt="wendy run deploying the Rust camera-feed container" />
