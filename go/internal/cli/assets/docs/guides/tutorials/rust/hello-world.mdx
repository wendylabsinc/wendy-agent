...
<Steps>
  <Step>
    ...
    <CliShot flow="init" step="wizard" alt="wendy init scaffolding the Rust hello-world project" />
  ...
  <Step>
    ...
    <CliShot flow="run" step="deploy" alt="wendy run building and deploying the Rust hello-world app" />

    <CliClip flow="run" alt="wendy run deploying the hello-world app end to end" />
...
<CliShot flow="apps-list" step="apps" alt="wendy device apps list showing the running hello-world app" />
