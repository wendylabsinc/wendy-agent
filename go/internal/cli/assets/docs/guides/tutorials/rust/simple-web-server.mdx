...
<Steps>
  <Step>
    ...
    <CliShot flow="init" step="wizard" alt="wendy init scaffolding the Rust simple-server project" />
  ...
  <Step>
    ...
    <CliShot flow="run" step="deploy" alt="wendy run deploying the Axum simple-server to a device" />
...
<CliShot flow="apps-list" step="apps" alt="wendy device apps list showing the running simple-server app" />
