...
<Steps>
  <Step>
    ...
    <CliShot flow="init" step="wizard" alt="wendy init scaffolding the Swift hello-world project" />
  ...
  <Step>
    ...
    <CliShot flow="run" step="deploy" alt="wendy run building and deploying the Swift hello-world app" />

    <CliClip flow="run" alt="wendy run deploying the Swift hello-world app end to end" />
