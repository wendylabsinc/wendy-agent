...
<Steps>
  <Step>
    ...
    <CliShot flow="init" step="wizard" alt="wendy init scaffolding the Swift camera-feed project" />
  ...
  <Step>
    ...
    <CliShot flow="run" step="deploy" alt="wendy run deploying the Swift camera-feed container" />
