...
- Read the [Raspberry Pi Installation](/docs/installation/wendyos-raspberry-pi-5) or [NVIDIA Jetson Orin Nano Installation](/docs/installation/wendyos-nvidia-jetson-orin-nano) guides if you also work with larger devices
