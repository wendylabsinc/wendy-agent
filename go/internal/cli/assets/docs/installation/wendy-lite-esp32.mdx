...
- Read the [Raspberry Pi Installation](/docs/installation/wendyos-raspberry-pi-5), [NVIDIA Jetson Orin Nano Installation](/docs/installation/wendyos-nvidia-jetson-orin-nano), or [NVIDIA Jetson AGX Thor Installation](/docs/installation/wendyos-nvidia-jetson-agx-thor) guides if you also work with larger devices
