...
> **Jetson AGX Orin users:** the installation steps below also apply to the AGX Orin. Select **Jetson AGX Orin** instead of **Jetson Orin Nano** when the CLI prompts for device type.
