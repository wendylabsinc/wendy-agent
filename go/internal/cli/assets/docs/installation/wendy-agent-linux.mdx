...
For Apple Silicon Mac targets, use [Wendy for Mac](/docs/wendy-for-mac). It follows the same `wendy-agent` model, but uses a macOS-specific app instead of this Linux install script.
