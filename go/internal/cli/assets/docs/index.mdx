...
<Cards className="grid-cols-2 lg:grid-cols-3">
  ...
  <div className="relative flex flex-col">
    ...
    <Card icon={<Microchip />} title="Wendy Lite" className="h-full">
      ESP32 runtime and deployment layer. Build and deploy regular native ESP-IDF projects with `wendy run`; Swift and WASM apps remain available when portability matters.
    </Card>
  </div>
</Cards>
