...
Unitree-specific packages that are not part of the public `unitree_ros2`
repository (for example onboard-only `unitree_interfaces` messages and newer
vendor-only service definitions) remain unavailable unless their definitions are
