...
3. **Observe.** Preprocess high-volume sensor data on the device and stream only
   what visible tools request. See [Wendy Observe](/docs/integrations/observe).
4. **Visualize.** Bridge live topics into Foxglove Studio for plots and panels. See
