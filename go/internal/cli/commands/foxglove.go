...
CMD ["bash","-lc","source /opt/ros/%[1]s/setup.bash && export ROS_LOCALHOST_ONLY=0 && exec ros2 launch foxglove_bridge foxglove_bridge_launch.xml port:=%[2]d address:=0.0.0.0"]
