...
const file_wendy_agent_services_v1_wendy_agent_v1_service_proto_rawDesc = "" +
	...
	"\"WIFI_SECURITY_TYPE_WPA2_ENTERPRISE\x10\x062\x96\x13\n" +
...
var file_wendy_agent_services_v1_wendy_agent_v1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_wendy_agent_services_v1_wendy_agent_v1_service_proto_goTypes = []any{
	...
	(*SetHostnameRequest)(nil),                                  // 42: wendy.agent.services.v1.SetHostnameRequest
	(*SetHostnameResponse)(nil),                                 // 43: wendy.agent.services.v1.SetHostnameResponse
	(*RunContainerRequest_Header)(nil),                          // 44: wendy.agent.services.v1.RunContainerRequest.Header
	(*RunContainerRequest_Chunk)(nil),                           // 45: wendy.agent.services.v1.RunContainerRequest.Chunk
	(*ControlCommand_Run)(nil),                                  // 46: wendy.agent.services.v1.ControlCommand.Run
	(*ControlCommand_Stop)(nil),                                 // 47: wendy.agent.services.v1.ControlCommand.Stop
	(*RunContainerResponse_Started)(nil),                        // 48: wendy.agent.services.v1.RunContainerResponse.Started
	(*RunContainerResponse_Stopped)(nil),                        // 49: wendy.agent.services.v1.RunContainerResponse.Stopped
	(*RunContainerResponse_ConsoleOutput)(nil),                  // 50: wendy.agent.services.v1.RunContainerResponse.ConsoleOutput
	(*UpdateAgentRequest_Chunk)(nil),                            // 51: wendy.agent.services.v1.UpdateAgentRequest.Chunk
	(*UpdateAgentRequest_ControlCommand)(nil),                   // 52: wendy.agent.services.v1.UpdateAgentRequest.ControlCommand
	(*UpdateAgentRequest_ControlCommand_Update)(nil),            // 53: wendy.agent.services.v1.UpdateAgentRequest.ControlCommand.Update
	(*UpdateAgentResponse_Updated)(nil),                         // 54: wendy.agent.services.v1.UpdateAgentResponse.Updated
	(*ListWiFiNetworksResponse_WiFiNetwork)(nil),                // 55: wendy.agent.services.v1.ListWiFiNetworksResponse.WiFiNetwork
	(*ListKnownWiFiNetworksResponse_KnownWiFiNetwork)(nil),      // 56: wendy.agent.services.v1.ListKnownWiFiNetworksResponse.KnownWiFiNetwork
	(*ListHardwareCapabilitiesResponse_HardwareCapability)(nil), // 57: wendy.agent.services.v1.ListHardwareCapabilitiesResponse.HardwareCapability
	nil,                                // 58: wendy.agent.services.v1.ListHardwareCapabilitiesResponse.HardwareCapability.PropertiesEntry
	(*UpdateOSResponse_Progress)(nil),  // 59: wendy.agent.services.v1.UpdateOSResponse.Progress
	(*UpdateOSResponse_Completed)(nil), // 60: wendy.agent.services.v1.UpdateOSResponse.Completed
	(*UpdateOSResponse_Failed)(nil),    // 61: wendy.agent.services.v1.UpdateOSResponse.Failed
	(*GetOSUpdateStatusResponse_ServiceResult)(nil), // 62: wendy.agent.services.v1.GetOSUpdateStatusResponse.ServiceResult
	(*RestartPolicy)(nil),                           // 63: RestartPolicy
}
var file_wendy_agent_services_v1_wendy_agent_v1_service_proto_depIdxs = []int32{
	44, // 0: wendy.agent.services.v1.RunContainerRequest.header:type_name -> wendy.agent.services.v1.RunContainerRequest.Header
	45, // 1: wendy.agent.services.v1.RunContainerRequest.chunk:type_name -> wendy.agent.services.v1.RunContainerRequest.Chunk
	4,  // 2: wendy.agent.services.v1.RunContainerRequest.control:type_name -> wendy.agent.services.v1.ControlCommand
	46, // 3: wendy.agent.services.v1.ControlCommand.run:type_name -> wendy.agent.services.v1.ControlCommand.Run
	47, // 4: wendy.agent.services.v1.ControlCommand.stop:type_name -> wendy.agent.services.v1.ControlCommand.Stop
	48, // 5: wendy.agent.services.v1.RunContainerResponse.started:type_name -> wendy.agent.services.v1.RunContainerResponse.Started
	49, // 6: wendy.agent.services.v1.RunContainerResponse.stopped:type_name -> wendy.agent.services.v1.RunContainerResponse.Stopped
	50, // 7: wendy.agent.services.v1.RunContainerResponse.stdout_output:type_name -> wendy.agent.services.v1.RunContainerResponse.ConsoleOutput
	50, // 8: wendy.agent.services.v1.RunContainerResponse.stderr_output:type_name -> wendy.agent.services.v1.RunContainerResponse.ConsoleOutput
	51, // 9: wendy.agent.services.v1.UpdateAgentRequest.chunk:type_name -> wendy.agent.services.v1.UpdateAgentRequest.Chunk
	52, // 10: wendy.agent.services.v1.UpdateAgentRequest.control:type_name -> wendy.agent.services.v1.UpdateAgentRequest.ControlCommand
	54, // 11: wendy.agent.services.v1.UpdateAgentResponse.updated:type_name -> wendy.agent.services.v1.UpdateAgentResponse.Updated
	10, // 12: wendy.agent.services.v1.GetAgentVersionResponse.partitions:type_name -> wendy.agent.services.v1.DiskPartition
	55, // 13: wendy.agent.services.v1.ListWiFiNetworksResponse.networks:type_name -> wendy.agent.services.v1.ListWiFiNetworksResponse.WiFiNetwork
	0,  // 14: wendy.agent.services.v1.ConnectToWiFiRequest.security:type_name -> wendy.agent.services.v1.WiFiSecurityType
	56, // 15: wendy.agent.services.v1.ListKnownWiFiNetworksResponse.networks:type_name -> wendy.agent.services.v1.ListKnownWiFiNetworksResponse.KnownWiFiNetwork
	57, // 16: wendy.agent.services.v1.ListHardwareCapabilitiesResponse.capabilities:type_name -> wendy.agent.services.v1.ListHardwareCapabilitiesResponse.HardwareCapability
	...
	59, // 18: wendy.agent.services.v1.UpdateOSResponse.progress:type_name -> wendy.agent.services.v1.UpdateOSResponse.Progress
	60, // 19: wendy.agent.services.v1.UpdateOSResponse.completed:type_name -> wendy.agent.services.v1.UpdateOSResponse.Completed
	61, // 20: wendy.agent.services.v1.UpdateOSResponse.failed:type_name -> wendy.agent.services.v1.UpdateOSResponse.Failed
	...
	62, // 22: wendy.agent.services.v1.GetOSUpdateStatusResponse.services:type_name -> wendy.agent.services.v1.GetOSUpdateStatusResponse.ServiceResult
	63, // 23: wendy.agent.services.v1.ControlCommand.Run.restart_policy:type_name -> RestartPolicy
	53, // 24: wendy.agent.services.v1.UpdateAgentRequest.ControlCommand.update:type_name -> wendy.agent.services.v1.UpdateAgentRequest.ControlCommand.Update
	...
	58, // 27: wendy.agent.services.v1.ListHardwareCapabilitiesResponse.HardwareCapability.properties:type_name -> wendy.agent.services.v1.ListHardwareCapabilitiesResponse.HardwareCapability.PropertiesEntry
	...
	42, // 47: wendy.agent.services.v1.WendyAgentService.SetHostname:input_type -> wendy.agent.services.v1.SetHostnameRequest
	5,  // 48: wendy.agent.services.v1.WendyAgentService.RunContainer:output_type -> wendy.agent.services.v1.RunContainerResponse
	7,  // 49: wendy.agent.services.v1.WendyAgentService.UpdateAgent:output_type -> wendy.agent.services.v1.UpdateAgentResponse
	9,  // 50: wendy.agent.services.v1.WendyAgentService.GetAgentVersion:output_type -> wendy.agent.services.v1.GetAgentVersionResponse
	12, // 51: wendy.agent.services.v1.WendyAgentService.ListWiFiNetworks:output_type -> wendy.agent.services.v1.ListWiFiNetworksResponse
	14, // 52: wendy.agent.services.v1.WendyAgentService.ConnectToWiFi:output_type -> wendy.agent.services.v1.ConnectToWiFiResponse
	16, // 53: wendy.agent.services.v1.WendyAgentService.GetWiFiStatus:output_type -> wendy.agent.services.v1.GetWiFiStatusResponse
	18, // 54: wendy.agent.services.v1.WendyAgentService.DisconnectWiFi:output_type -> wendy.agent.services.v1.DisconnectWiFiResponse
	20, // 55: wendy.agent.services.v1.WendyAgentService.ListKnownWiFiNetworks:output_type -> wendy.agent.services.v1.ListKnownWiFiNetworksResponse
	22, // 56: wendy.agent.services.v1.WendyAgentService.SetWiFiNetworkPriority:output_type -> wendy.agent.services.v1.SetWiFiNetworkPriorityResponse
	24, // 57: wendy.agent.services.v1.WendyAgentService.ReorderKnownWiFiNetworks:output_type -> wendy.agent.services.v1.ReorderKnownWiFiNetworksResponse
	26, // 58: wendy.agent.services.v1.WendyAgentService.ForgetWiFiNetwork:output_type -> wendy.agent.services.v1.ForgetWiFiNetworkResponse
	28, // 59: wendy.agent.services.v1.WendyAgentService.ListHardwareCapabilities:output_type -> wendy.agent.services.v1.ListHardwareCapabilitiesResponse
	31, // 60: wendy.agent.services.v1.WendyAgentService.ScanBluetoothPeripherals:output_type -> wendy.agent.services.v1.ScanBluetoothPeripheralsResponse
	33, // 61: wendy.agent.services.v1.WendyAgentService.ConnectBluetoothPeripheral:output_type -> wendy.agent.services.v1.ConnectBluetoothPeripheralResponse
	35, // 62: wendy.agent.services.v1.WendyAgentService.DisconnectBluetoothPeripheral:output_type -> wendy.agent.services.v1.DisconnectBluetoothPeripheralResponse
	37, // 63: wendy.agent.services.v1.WendyAgentService.ForgetBluetoothPeripheral:output_type -> wendy.agent.services.v1.ForgetBluetoothPeripheralResponse
	39, // 64: wendy.agent.services.v1.WendyAgentService.UpdateOS:output_type -> wendy.agent.services.v1.UpdateOSResponse
	41, // 65: wendy.agent.services.v1.WendyAgentService.GetOSUpdateStatus:output_type -> wendy.agent.services.v1.GetOSUpdateStatusResponse
	43, // 66: wendy.agent.services.v1.WendyAgentService.SetHostname:output_type -> wendy.agent.services.v1.SetHostnameResponse
...
func file_wendy_agent_services_v1_wendy_agent_v1_service_proto_init() {
	...
	file_wendy_agent_services_v1_wendy_agent_v1_service_proto_msgTypes[43].OneofWrappers = []any{}
