...
type UpdateOSResponse struct {
	...
	//	*UpdateOSResponse_ArmingRedundancy_
...
func (x *UpdateOSResponse) GetArmingRedundancy() *UpdateOSResponse_ArmingRedundancy {
	if x != nil {
		if x, ok := x.ResponseType.(*UpdateOSResponse_ArmingRedundancy_); ok {
			return x.ArmingRedundancy
		}
	}
	return nil
}
...
type UpdateOSResponse_ArmingRedundancy_ struct {
	...
	ArmingRedundancy *UpdateOSResponse_ArmingRedundancy `protobuf:"bytes,4,opt,name=arming_redundancy,json=armingRedundancy,proto3,oneof"`
}
...
func (*UpdateOSResponse_ArmingRedundancy_) isUpdateOSResponse_ResponseType() {}
...
type UpdateOSResponse_ArmingRedundancy struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	WillReboot    bool `protobuf:"varint,2,opt,name=will_reboot,json=willReboot,proto3" json:"will_reboot,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdateOSResponse_ArmingRedundancy) Reset() {
	*x = UpdateOSResponse_ArmingRedundancy{}
	mi := &file_wendy_agent_services_v1_wendy_agent_v1_service_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateOSResponse_ArmingRedundancy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateOSResponse_ArmingRedundancy) ProtoMessage() {}

func (x *UpdateOSResponse_ArmingRedundancy) ProtoReflect() protoreflect.Message {
	mi := &file_wendy_agent_services_v1_wendy_agent_v1_service_proto_msgTypes[64]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateOSResponse_ArmingRedundancy.ProtoReflect.Descriptor instead.
func (*UpdateOSResponse_ArmingRedundancy) Descriptor() ([]byte, []int) {
	return file_wendy_agent_services_v1_wendy_agent_v1_service_proto_rawDescGZIP(), []int{37, 3}
}

func (x *UpdateOSResponse_ArmingRedundancy) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *UpdateOSResponse_ArmingRedundancy) GetWillReboot() bool {
	if x != nil {
		return x.WillReboot
	}
	return false
...
const file_wendy_agent_services_v1_wendy_agent_v1_service_proto_rawDesc = "" +
	...
	"\x0fupdater_backend\x18\x02 \x01(\tR\x0eupdaterBackend\"\xf1\x04\n" +
	...
	"\x06failed\x18\x03 \x01(\v20.wendy.agent.services.v1.UpdateOSResponse.FailedH\x00R\x06failed\x12i\n" +
	"\x11arming_redundancy\x18\x04 \x01(\v2:.wendy.agent.services.v1.UpdateOSResponse.ArmingRedundancyH\x00R\x10armingRedundancy\x1a:\n" +
	"\bProgress\x12\x14\n" +
	...
	"\x06Failed\x12#\n" +
	"\rerror_message\x18\x01 \x01(\tR\ferrorMessage\x1aM\n" +
	"\x10ArmingRedundancy\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x1f\n" +
	"\vwill_reboot\x18\x02 \x01(\bR\n" +
	"willRebootB\x0f\n" +
	"\rresponse_type\">\n" +
...
var file_wendy_agent_services_v1_wendy_agent_v1_service_proto_goTypes = []any{
	...
	(*UpdateOSResponse_ArmingRedundancy)(nil),  // 67: wendy.agent.services.v1.UpdateOSResponse.ArmingRedundancy
...
var file_wendy_agent_services_v1_wendy_agent_v1_service_proto_depIdxs = []int32{
	...
	67, // 22: wendy.agent.services.v1.UpdateOSResponse.arming_redundancy:type_name -> wendy.agent.services.v1.UpdateOSResponse.ArmingRedundancy
	43, // 23: wendy.agent.services.v1.DumpKernelLogResponse.records:type_name -> wendy.agent.services.v1.KernelLogRecord
	68, // 24: wendy.agent.services.v1.OSUpdateEngineStatus.slots:type_name -> wendy.agent.services.v1.OSUpdateEngineStatus.Slot
	69, // 25: wendy.agent.services.v1.OSUpdateEngineStatus.system:type_name -> wendy.agent.services.v1.OSUpdateEngineStatus.SystemEntry
	70, // 26: wendy.agent.services.v1.OSUpdateEngineStatus.pending:type_name -> wendy.agent.services.v1.OSUpdateEngineStatus.PendingUpdate
	71, // 27: wendy.agent.services.v1.OSUpdateEngineStatus.diagnostics:type_name -> wendy.agent.services.v1.OSUpdateEngineStatus.DiagnosticsEntry
	...
	72, // 29: wendy.agent.services.v1.GetOSUpdateStatusResponse.services:type_name -> wendy.agent.services.v1.GetOSUpdateStatusResponse.ServiceResult
...
func file_wendy_agent_services_v1_wendy_agent_v1_service_proto_init() {
	...
	file_wendy_agent_services_v1_wendy_agent_v1_service_proto_msgTypes[37].OneofWrappers = []any{
		...
		(*UpdateOSResponse_ArmingRedundancy_)(nil),
	}
