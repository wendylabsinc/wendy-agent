...
func (c *wendyDeviceInfoServiceClient) SetHardwareWatchList(ctx context.Context, in *SetHardwareWatchListRequest, opts ...grpc.CallOption) (*SetHardwareWatchListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetHardwareWatchListResponse)
	err := c.cc.Invoke(ctx, WendyDeviceInfoService_SetHardwareWatchList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WendyDeviceInfoService_SetHardwareWatchList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(WendyDeviceInfoServiceServer).SetHardwareWatchList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WendyDeviceInfoService_SetHardwareWatchList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WendyDeviceInfoServiceServer).SetHardwareWatchList(ctx, req.(*SetHardwareWatchListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
