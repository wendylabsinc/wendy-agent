...
type GetDeviceInfoResponse struct {
	...
	MemTotalBytes *int64 `protobuf:"varint,16,opt,name=mem_total_bytes,json=memTotalBytes,proto3,oneof" json:"mem_total_bytes,omitempty"`
	// Number of online logical CPU cores, from /proc/stat. Only present when
	// the agent can read it.
	CpuCount      *uint32 `protobuf:"varint,17,opt,name=cpu_count,json=cpuCount,proto3,oneof" json:"cpu_count,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_wendy_agent_services_v2_device_info_service_proto_rawDesc = "" +
	...
	"\x14GetDeviceInfoRequest\"\xeb\x06\n" +
	...
	"\x0fmem_total_bytes\x18\x10 \x01(\x03H\n" +
	"R\rmemTotalBytes\x88\x01\x01\x12 \n" +
	"\tcpu_count\x18\x11 \x01(\rH\vR\bcpuCount\x88\x01\x01B\r\n" +
	"\v_os_versionB\r\n" +
	"\v_public_keyB\x0e\n" +
	"\f_device_typeB\n" +
	"\n" +
