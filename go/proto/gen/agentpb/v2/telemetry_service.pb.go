...
type StreamMetricsRequest struct {
	...
	AppName          *string                `protobuf:"bytes,3,opt,name=app_name,json=appName,proto3,oneof" json:"app_name,omitempty"`
	LastN            *int32                 `protobuf:"varint,4,opt,name=last_n,json=lastN,proto3,oneof" json:"last_n,omitempty"` // replay last N metric batches before going live
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type StreamTracesRequest struct {
	...
	LastN          *int32                 `protobuf:"varint,4,opt,name=last_n,json=lastN,proto3,oneof" json:"last_n,omitempty"` // replay last N trace batches before going live
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
