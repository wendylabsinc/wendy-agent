...
const (
	...
	WendyContainerService_UpdateRunningContainerMetadata_FullMethodName = "/wendy.agent.services.v1.WendyContainerService/UpdateRunningContainerMetadata"
...
type WendyContainerServiceClient interface {
	...
	// UpdateRunningContainerMetadata reconciles metadata that does not affect
	// the OCI spec or writable snapshot. It only succeeds for a running,
	// single-container app; callers must perform a full deploy otherwise.
	UpdateRunningContainerMetadata(ctx context.Context, in *UpdateRunningContainerMetadataRequest, opts ...grpc.CallOption) (*UpdateRunningContainerMetadataResponse, error)
...
func (c *wendyContainerServiceClient) UpdateRunningContainerMetadata(ctx context.Context, in *UpdateRunningContainerMetadataRequest, opts ...grpc.CallOption) (*UpdateRunningContainerMetadataResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateRunningContainerMetadataResponse)
	err := c.cc.Invoke(ctx, WendyContainerService_UpdateRunningContainerMetadata_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WendyContainerServiceServer interface {
	...
	// the OCI spec or writable snapshot. It only succeeds for a running,
	// single-container app; callers must perform a full deploy otherwise.
	UpdateRunningContainerMetadata(context.Context, *UpdateRunningContainerMetadataRequest) (*UpdateRunningContainerMetadataResponse, error)
...
func (UnimplementedWendyContainerServiceServer) UpdateRunningContainerMetadata(context.Context, *UpdateRunningContainerMetadataRequest) (*UpdateRunningContainerMetadataResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateRunningContainerMetadata not implemented")
}
...
func _WendyContainerService_UpdateRunningContainerMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateRunningContainerMetadataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WendyContainerServiceServer).UpdateRunningContainerMetadata(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WendyContainerService_UpdateRunningContainerMetadata_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WendyContainerServiceServer).UpdateRunningContainerMetadata(ctx, req.(*UpdateRunningContainerMetadataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WendyContainerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateRunningContainerMetadata",
			Handler:    _WendyContainerService_UpdateRunningContainerMetadata_Handler,
		},
		{
