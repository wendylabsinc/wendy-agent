...
func (CreateContainerProgress_Phase) EnumDescriptor() ([]byte, []int) {
	return file_wendy_agent_services_v1_wendy_agent_v1_container_service_proto_rawDescGZIP(), []int{10, 0}
}
...
type CreateContainerRequest struct {
	...
	RegistryAuth  *RegistryAuth `protobuf:"bytes,9,opt,name=registry_auth,json=registryAuth,proto3,oneof" json:"registry_auth,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateContainerRequest) GetRegistryAuth() *RegistryAuth {
	if x != nil {
...
type RegistryAuth struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RegistryHost  string                 `protobuf:"bytes,1,opt,name=registry_host,json=registryHost,proto3" json:"registry_host,omitempty"` // e.g. "docker.io", "ghcr.io", "registry.wendy.sh"
	Username      string                 `protobuf:"bytes,2,opt,name=username,proto3" json:"username,omitempty"`
	Password      string                 `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"` // password or token
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegistryAuth) GetRegistryHost() string {
	if x != nil {
...
func (*RunContainerLayersResponse_Started) Descriptor() ([]byte, []int) {
	return file_wendy_agent_services_v1_wendy_agent_v1_container_service_proto_rawDescGZIP(), []int{15, 0}
}
...
func (*RunContainerLayersResponse_ConsoleOutput) Descriptor() ([]byte, []int) {
	return file_wendy_agent_services_v1_wendy_agent_v1_container_service_proto_rawDescGZIP(), []int{15, 1}
}
...
const file_wendy_agent_services_v1_wendy_agent_v1_container_service_proto_rawDesc = "" +
	...
	"\x03env\x18\b \x03(\tR\x03env\x12O\n" +
	"\rregistry_auth\x18\t \x01(\v2%.wendy.agent.services.v1.RegistryAuthH\x01R\fregistryAuth\x88\x01\x01B\x11\n" +
	"\x0f_restart_policyB\x10\n" +
	"\x0e_registry_auth\"\x19\n" +
	"\x17CreateContainerResponse\"k\n" +
	"\fRegistryAuth\x12#\n" +
	"\rregistry_host\x18\x01 \x01(\tR\fregistryHost\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\"\xdc\x02\n" +
...
var file_wendy_agent_services_v1_wendy_agent_v1_container_service_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_wendy_agent_services_v1_wendy_agent_v1_container_service_proto_goTypes = []any{
	...
	(*RegistryAuth)(nil),                             // 11: wendy.agent.services.v1.RegistryAuth
	...
	(*RunContainerLayersResponse_Started)(nil),       // 31: wendy.agent.services.v1.RunContainerLayersResponse.Started
	(*RunContainerLayersResponse_ConsoleOutput)(nil), // 32: wendy.agent.services.v1.RunContainerLayersResponse.ConsoleOutput
	(*AppContainer)(nil),                             // 33: AppContainer
	(*RestartPolicy)(nil),                            // 34: RestartPolicy
}
var file_wendy_agent_services_v1_wendy_agent_v1_container_service_proto_depIdxs = []int32{
	33, // 0: wendy.agent.services.v1.ListContainersResponse.container:type_name -> AppContainer
	16, // 1: wendy.agent.services.v1.RunContainerLayersRequest.layers:type_name -> wendy.agent.services.v1.RunContainerLayerHeader
	34, // 2: wendy.agent.services.v1.RunContainerLayersRequest.restart_policy:type_name -> RestartPolicy
	34, // 3: wendy.agent.services.v1.CreateContainerRequest.restart_policy:type_name -> RestartPolicy
	11, // 4: wendy.agent.services.v1.CreateContainerRequest.registry_auth:type_name -> wendy.agent.services.v1.RegistryAuth
	...
	12, // 6: wendy.agent.services.v1.CreateContainerProgressResponse.progress:type_name -> wendy.agent.services.v1.CreateContainerProgress
	10, // 7: wendy.agent.services.v1.CreateContainerProgressResponse.completed:type_name -> wendy.agent.services.v1.CreateContainerResponse
	34, // 8: wendy.agent.services.v1.StartContainerRequest.restart_policy:type_name -> RestartPolicy
	...
	31, // 10: wendy.agent.services.v1.RunContainerLayersResponse.started:type_name -> wendy.agent.services.v1.RunContainerLayersResponse.Started
	32, // 11: wendy.agent.services.v1.RunContainerLayersResponse.stdout_output:type_name -> wendy.agent.services.v1.RunContainerLayersResponse.ConsoleOutput
	32, // 12: wendy.agent.services.v1.RunContainerLayersResponse.stderr_output:type_name -> wendy.agent.services.v1.RunContainerLayersResponse.ConsoleOutput
	23, // 13: wendy.agent.services.v1.ListVolumesResponse.volumes:type_name -> wendy.agent.services.v1.VolumeInfo
	27, // 14: wendy.agent.services.v1.ListContainerStatsResponse.stats:type_name -> wendy.agent.services.v1.ContainerStats
	4,  // 15: wendy.agent.services.v1.WendyContainerService.ListLayers:input_type -> wendy.agent.services.v1.ListLayersRequest
	5,  // 16: wendy.agent.services.v1.WendyContainerService.WriteLayer:input_type -> wendy.agent.services.v1.WriteLayerRequest
	9,  // 17: wendy.agent.services.v1.WendyContainerService.CreateContainer:input_type -> wendy.agent.services.v1.CreateContainerRequest
	9,  // 18: wendy.agent.services.v1.WendyContainerService.CreateContainerWithProgress:input_type -> wendy.agent.services.v1.CreateContainerRequest
	8,  // 19: wendy.agent.services.v1.WendyContainerService.RunContainer:input_type -> wendy.agent.services.v1.RunContainerLayersRequest
	14, // 20: wendy.agent.services.v1.WendyContainerService.StartContainer:input_type -> wendy.agent.services.v1.StartContainerRequest
	15, // 21: wendy.agent.services.v1.WendyContainerService.AttachContainer:input_type -> wendy.agent.services.v1.AttachContainerRequest
	18, // 22: wendy.agent.services.v1.WendyContainerService.StopContainer:input_type -> wendy.agent.services.v1.StopContainerRequest
	20, // 23: wendy.agent.services.v1.WendyContainerService.DeleteContainer:input_type -> wendy.agent.services.v1.DeleteContainerRequest
	2,  // 24: wendy.agent.services.v1.WendyContainerService.ListContainers:input_type -> wendy.agent.services.v1.ListContainersRequest
	22, // 25: wendy.agent.services.v1.WendyContainerService.ListVolumes:input_type -> wendy.agent.services.v1.ListVolumesRequest
	25, // 26: wendy.agent.services.v1.WendyContainerService.RemoveVolume:input_type -> wendy.agent.services.v1.RemoveVolumeRequest
	28, // 27: wendy.agent.services.v1.WendyContainerService.ListContainerStats:input_type -> wendy.agent.services.v1.ListContainerStatsRequest
	30, // 28: wendy.agent.services.v1.WendyContainerService.StreamMCP:input_type -> wendy.agent.services.v1.MCPChunk
	7,  // 29: wendy.agent.services.v1.WendyContainerService.ListLayers:output_type -> wendy.agent.services.v1.LayerHeader
	6,  // 30: wendy.agent.services.v1.WendyContainerService.WriteLayer:output_type -> wendy.agent.services.v1.WriteLayerResponse
	10, // 31: wendy.agent.services.v1.WendyContainerService.CreateContainer:output_type -> wendy.agent.services.v1.CreateContainerResponse
	13, // 32: wendy.agent.services.v1.WendyContainerService.CreateContainerWithProgress:output_type -> wendy.agent.services.v1.CreateContainerProgressResponse
	17, // 33: wendy.agent.services.v1.WendyContainerService.RunContainer:output_type -> wendy.agent.services.v1.RunContainerLayersResponse
	17, // 34: wendy.agent.services.v1.WendyContainerService.StartContainer:output_type -> wendy.agent.services.v1.RunContainerLayersResponse
	17, // 35: wendy.agent.services.v1.WendyContainerService.AttachContainer:output_type -> wendy.agent.services.v1.RunContainerLayersResponse
	19, // 36: wendy.agent.services.v1.WendyContainerService.StopContainer:output_type -> wendy.agent.services.v1.StopContainerResponse
	21, // 37: wendy.agent.services.v1.WendyContainerService.DeleteContainer:output_type -> wendy.agent.services.v1.DeleteContainerResponse
	3,  // 38: wendy.agent.services.v1.WendyContainerService.ListContainers:output_type -> wendy.agent.services.v1.ListContainersResponse
	24, // 39: wendy.agent.services.v1.WendyContainerService.ListVolumes:output_type -> wendy.agent.services.v1.ListVolumesResponse
	26, // 40: wendy.agent.services.v1.WendyContainerService.RemoveVolume:output_type -> wendy.agent.services.v1.RemoveVolumeResponse
	29, // 41: wendy.agent.services.v1.WendyContainerService.ListContainerStats:output_type -> wendy.agent.services.v1.ListContainerStatsResponse
	30, // 42: wendy.agent.services.v1.WendyContainerService.StreamMCP:output_type -> wendy.agent.services.v1.MCPChunk
