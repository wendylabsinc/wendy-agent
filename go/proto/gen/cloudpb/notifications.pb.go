...
type NotificationAudience_OrganizationRole struct {
	OrganizationRole OrganizationRole `protobuf:"varint,3,opt,name=organization_role,json=organizationRole,proto3,enum=wendycloud.v1.OrganizationRole,oneof"`
}
...
const file_cloud_notifications_proto_rawDesc = "" +
	"\n" +
	"\x19cloud/notifications.proto\x12\rwendycloud.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x19cloud/organizations.proto\"\xaf\x01\n" +
	"\x14NotificationAudience\x12\x19\n" +
	"\auser_id\x18\x01 \x01(\tH\x00R\x06userId\x12 \n" +
	"\vorg_team_id\x18\x02 \x01(\x05H\x00R\torgTeamId\x12N\n" +
	"\x11organization_role\x18\x03 \x01(\x0e2\x1f.wendycloud.v1.OrganizationRoleH\x00R\x10organizationRoleB\n" +
	"\n" +
	"\baudience\"\xa8\x06\n" +
...
var file_cloud_notifications_proto_depIdxs = []int32{
	15, // 0: wendycloud.v1.NotificationAudience.organization_role:type_name -> wendycloud.v1.OrganizationRole
