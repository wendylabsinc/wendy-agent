...
public struct Containerd_Services_Events_V1_PublishRequest: Sendable {
...
public struct Containerd_Services_Events_V1_ForwardRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Containerd_Services_Events_V1_SubscribeRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "containerd.services.events.v1"

extension Containerd_Services_Events_V1_PublishRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PublishRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}topic\0\u{1}event\0")
  ...
  public static func ==(lhs: Containerd_Services_Events_V1_PublishRequest, rhs: Containerd_Services_Events_V1_PublishRequest) -> Bool {
...
extension Containerd_Services_Events_V1_ForwardRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Containerd_Services_Events_V1_ForwardRequest, rhs: Containerd_Services_Events_V1_ForwardRequest) -> Bool {
...
extension Containerd_Services_Events_V1_SubscribeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Containerd_Services_Events_V1_SubscribeRequest, rhs: Containerd_Services_Events_V1_SubscribeRequest) -> Bool {
