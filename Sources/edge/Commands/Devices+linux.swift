            ...
            do {
                ...
                for line in output.split(separator: "\n") {
                    ...
                    if deviceInfo.contains("EdgeOS") {
                        ...
                        if let idRange = deviceInfo.range(of: "ID \\S+", options: .regularExpression) {
                            ...
                            if parts.count == 2,
                               ...
                               let productId = Int(parts[1], radix: 16) {
                                ...
                                let nameStartIndex = deviceInfo.index(idRange.upperBound, offsetBy: 1)
                                if nameStartIndex < deviceInfo.endIndex {
                                    let name = String(deviceInfo[nameStartIndex...]).trimmingCharacters(in: .whitespaces)
                                    ...
                                    logger.info("Found EdgeOS USB device: \(name)", metadata: [
