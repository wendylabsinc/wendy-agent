    ...
    struct PlatformDeviceDiscovery: DeviceDiscovery {
        ...
        private func processInterfaces(
            interfaces: [NetworkInterface],
            logger: Logger,
            foundEdgeOSInterfaces: inout Bool
        ) {
        ...
        private func fallbackInterfaceParsing(
            output: String,
            logger: Logger,
            foundEdgeOSInterfaces: inout Bool
        ) {
