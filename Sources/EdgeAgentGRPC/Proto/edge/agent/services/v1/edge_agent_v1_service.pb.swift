...
public struct Edge_Agent_Services_V1_RunContainerRequest: Sendable {
  ...
  public struct ControlCommand: Sendable {
    ...
    public struct Run: Sendable {
      ...
      /// The entitlements for the container.
      public var entitlements: Edge_Agent_Services_V1_ContainerEntitlements {
        get {return _entitlements ?? Edge_Agent_Services_V1_ContainerEntitlements()}
        set {_entitlements = newValue}
      }
      /// Returns true if `entitlements` has been explicitly set.
      public var hasEntitlements: Bool {return self._entitlements != nil}
      /// Clears the value of `entitlements`. Subsequent reads from it will return its default value.
      public mutating func clearEntitlements() {self._entitlements = nil}

      public var unknownFields = SwiftProtobuf.UnknownStorage()

      public init() {}

      fileprivate var _entitlements: Edge_Agent_Services_V1_ContainerEntitlements? = nil
    }
...
public struct Edge_Agent_Services_V1_ContainerEntitlements: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var entitlements: [Edge_Agent_Services_V1_ContainerEntitlement] = []
...
public struct Edge_Agent_Services_V1_ContainerEntitlement: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var entitlement: Edge_Agent_Services_V1_ContainerEntitlement.OneOf_Entitlement? = nil

  public var dbus: Edge_Agent_Services_V1_ContainerEntitlement.Dbus {
    get {
      if case .dbus(let v)? = entitlement {return v}
      return Edge_Agent_Services_V1_ContainerEntitlement.Dbus()
    }
    set {entitlement = .dbus(newValue)}
  }

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public enum OneOf_Entitlement: Equatable, Sendable {
    case dbus(Edge_Agent_Services_V1_ContainerEntitlement.Dbus)

  }

  public struct Dbus: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Edge_Agent_Services_V1_RunContainerRequest.ControlCommand.Run: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._entitlements) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._entitlements {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Edge_Agent_Services_V1_RunContainerRequest.ControlCommand.Run, rhs: Edge_Agent_Services_V1_RunContainerRequest.ControlCommand.Run) -> Bool {
    ...
    if lhs._entitlements != rhs._entitlements {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Edge_Agent_Services_V1_ContainerEntitlements: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ContainerEntitlements"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "entitlements"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.entitlements) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.entitlements.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.entitlements, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Edge_Agent_Services_V1_ContainerEntitlements, rhs: Edge_Agent_Services_V1_ContainerEntitlements) -> Bool {
...
extension Edge_Agent_Services_V1_ContainerEntitlement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ContainerEntitlement"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "dbus"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Edge_Agent_Services_V1_ContainerEntitlement.Dbus?
        var hadOneofValue = false
        if let current = self.entitlement {
          hadOneofValue = true
          if case .dbus(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.entitlement = .dbus(v)
        }
      }()
      default: break
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if case .dbus(let v)? = self.entitlement {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Edge_Agent_Services_V1_ContainerEntitlement, rhs: Edge_Agent_Services_V1_ContainerEntitlement) -> Bool {
    if lhs.entitlement != rhs.entitlement {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Edge_Agent_Services_V1_ContainerEntitlement.Dbus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Edge_Agent_Services_V1_ContainerEntitlement.protoMessageName + ".Dbus"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Edge_Agent_Services_V1_ContainerEntitlement.Dbus, rhs: Edge_Agent_Services_V1_ContainerEntitlement.Dbus) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
