...
struct HardwareCommand: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        abstract: "Discover and list hardware capabilities on the edge device"
    )
    ...
    private func discoverHardware() async throws
        -> [Edge_Agent_Services_V1_ListHardwareCapabilitiesResponse.HardwareCapability]
    {
        return try await withGRPCClient(agentConnectionOptions) { client in
            ...
            var request = Edge_Agent_Services_V1_ListHardwareCapabilitiesRequest()
    ...
    private func outputJSON(
        _ capabilities: [Edge_Agent_Services_V1_ListHardwareCapabilitiesResponse.HardwareCapability]
    ) throws {
    ...
    private func outputText(
        _ capabilities: [Edge_Agent_Services_V1_ListHardwareCapabilitiesResponse
            .HardwareCapability],
        logger: Logger
    ) {
