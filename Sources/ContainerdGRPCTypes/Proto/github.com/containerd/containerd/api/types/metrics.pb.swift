...
public struct Containerd_Types_Metric: Sendable {
...
extension Containerd_Types_Metric: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Metric"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}timestamp\0\u{1}id\0\u{1}data\0")
  ...
  public static func ==(lhs: Containerd_Types_Metric, rhs: Containerd_Types_Metric) -> Bool {
