...
actor WendyProvisioningService: Wendy_Agent_Services_V1_WendyProvisioningService.ServiceProtocol {
    ...
    func provision(
        request: StreamingServerRequest<Wendy_Agent_Services_V1_ProvisioningRequest>,
        context: ServerContext
    ) async throws -> StreamingServerResponse<Wendy_Agent_Services_V1_ProvisioningResponse> {
