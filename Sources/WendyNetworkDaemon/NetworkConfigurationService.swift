    ...
    actor NetworkConfigurationService {
        ...
        func configureInterface(
            ...
            guard let prefs = SCPreferencesCreate(nil, "WendyNetworkDaemon" as CFString, nil) else {
        ...
        private func findNetworkService(for bsdName: String) -> SCNetworkService? {
            guard let prefs = SCPreferencesCreate(nil, "WendyNetworkDaemon" as CFString, nil),
